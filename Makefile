...
# To have the inspector, load aframe-inspector and dat-gui
	./dist/build/aframe-server/aframe-server examples/hello-world.html \
...
testme::
	cabal build && npm run build && cabal install && ./dist/build/aframe-server/aframe-server examples/hello-world.html