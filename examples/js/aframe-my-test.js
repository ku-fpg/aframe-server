AFRAME.registerComponent('segments', {
  schema: { default: 10, type: 'number' },
  init: function () {
//    this.el.getObject3D('mesh').geometry
    this.el.getObject3D('mesh').geometry = new THREE.PlaneBufferGeometry(10,10,10,10);
    this.el.getObject3D('mesh').material.wireframe = true;
    
    console.log("sgments",this.el.getObject3D('mesh').geometry)
// xx.el.object3DMap.mesh.material.wireframe = true
//var x = xx.el.getObject3D('mesh').geometry = new THREE.PlaneBufferGeometry(10,10,10,10)
    xx = this;
  }  
});

/*
AFRAME.registerGeometry('my-plane', {
  schema: {
